const About = () => {
  return (
    <section style={{ fontFamily: 'Roboto Mono, monospace' }} className="flex flex-col text-white items-center justify-center  pl-10 pr-10">
      <h2
      ...
      >
        ...
        Harvard.</p> <p className="mt-4 text-white font-bold text-2xl sm:text-2xl
         md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-3xl"> &nbsp; I continued with variety
        of different courses from
        Freecodecamp, Youtube and Telerik Academy. <br/> Then I started creating my
